...
class BASICToken:
        ...
        SEMICOLON       = 79  # ';'
        EXPONENT        = 80  # '^'
        CLEAR           = 81  # CLEAR command
        HOME            = 82  # HOME keyword
        HTAB            = 83  # HTAB keyword
        VTAB            = 84  # VTAB keyword
        RESTORE         = 85  # RESTORE keyword
        SND             = 86  # SND keyword (enhancement)
        IMG             = 87  # IMG keyword (enhancement)
        PAUSE           = 88  # PAUSE keyword (enhancement)
        ...
        'RNDINT', 'GET', 'SEMICOLON', 'EXPONENT', 'CLEAR',
        'HOME', 'HTAB', 'VTAB', 'RESTORE', 'SND','IMG',
        'PAUSE']
        ...
        keywords = {'LET': LET, 'LIST': LIST, 'PRINT': PRINT,
                    ...
                    'INSTR': INSTR, 'STOP': STOP,
                    'AND': AND, 'OR': OR, 'NOT': NOT,
                    'PI': PI, 'RNDINT': RNDINT,
                    'GET': GET, 'CLEAR': CLEAR,
                    'HOME': HOME, 'HTAB': HTAB,
                    'VTAB': VTAB, 'RESTORE': RESTORE,
                    'SND': SND, 'IMG': IMG,
                    'PAUSE': PAUSE}
