...
class Program:
    ...
    def get_line(self, line_number):
        """Returns the program statement
        identified by line_number

        :return: A string representing
        the program statement
        """
        return self.__program[line_number]
    ...
    def __reset(self):
        """Reset the statement pointer and return stack
        """
        self.__next_stmt = 0
        self.__return_stack = []
    ...
    def delete(self):
        ...
        and reseting the statement pointer and return stack
        """
